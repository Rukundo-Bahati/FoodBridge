...
const Hero = () => {
  return (
    <section className="min-h-screen gradient-bg flex items-center justify-center text-white relative overflow-hidden">
      ...
      <div className="w-full px-4 text-center relative z-10 animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          ...
          <Button size="lg" variant="outline" className="border-white text-black hover:bg-white hover:text-primary text-lg px-8 py-4">
